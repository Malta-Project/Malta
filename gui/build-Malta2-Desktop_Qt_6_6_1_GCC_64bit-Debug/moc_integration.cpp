...
static constexpr auto qt_meta_stringdata_CLASSIntegrationENDCLASS = QtMocHelpers::stringData(
    "Integration"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSIntegrationENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSIntegrationENDCLASS_t qt_meta_stringdata_CLASSIntegrationENDCLASS = {
    {
        QT_MOC_LITERAL(0, 11)   // "Integration"
    },
    "Integration"
};
